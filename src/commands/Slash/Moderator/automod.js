...
module.exports = {
    config: {
        name: "automod",
        category: "Moderator",
        description: `sets up the automod system.`,
        usage: "Figure it out yourself dumb dumb",
        type: "slash", // or "slash"
        cooldown: 5
    },
    ...
    async execute (interaction) {
        ...
        switch (sub) {
            ...
            const rule = await guild.autoModerationRules.create({
                name: `Block profinity, sexual content, and slurs by Maru v2.`,
                creatorId: '893038810902958130',
                enabled: true,
                eventType: 1,
                triggerType: 4,
                triggerMetadata: 
                ...
                actions: [
                    {
                        ...
                        metadata: {
                            ...
                            durationSeconds: 10,
                            customMessage: 'This message was prevented by Maru v2!'
                        }
                    }
                ]
            }).catch(async err => {
            ...
            const rule2 = await guild.autoModerationRules.create({
                name: `Prevent the word ${word} by Maru v2.`,
                creatorId: '893038810902958130',
                enabled: true,
                eventType: 1,
                triggerType: 1,
            ...
            const rule3 = await guild.autoModerationRules.create({
                name: 'Prevent Spam Messages by Maru v2.',
                creatorId: '893038810902958130',
                enabled: true,
                eventType: 1,
                triggerType: 5,
            ...
            const rule4 = await guild.autoModerationRules.create({
                name: `Prevent Spam Mentions by Maru v2.`,
                creatorId: '893038810902958130',
                enabled: true,
                eventType: 1,
                triggerType: 5,
